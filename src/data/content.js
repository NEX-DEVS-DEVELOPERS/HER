...
export const letterContent = {
  ...
  paragraphs: [
    ...
    "You are the one who never steps back no matter how stormy the sprint gets—you stand beside me, steady, and refuse to let me forget who I'm building for.",
  ...
  timeline: [
    {
      label: 'Met',
      detail: '11 May 2023 — the day distance had to make room for us.',
    },
    {
      label: 'Today',
    ...
    {
      label: 'Next reunion',
      detail: '30 October — celebrating your smile in person soon.',
    },
  ],
  highlights: [
    ...
    'In the promises we whisper—of the life we\'re shaping together.',
  ],
};
...
export const gratitudeContent = [
  ...
  },
  {
    ...
    copy: 'You look past the long nights and see the future we\'re designing—one where Nex-Devs lifts us both.',
  },
  {
    title: 'Quiet support',
...
export const promiseContent = {
  ...
  promises: [
    'I will carve out time for us even while I build—because you are the reason I build at all.',
    "When success arrives, the first gift is yours: rest, joy, and the world you ask for.",
    'I will marry you, Eman. Not someday—on the day our dreams are ready, and you\'re smiling right beside me.',
  ],
...
export const statusHighlights = {
  location: {
    label: 'Where I am',
    value: 'Tap “Update location” below so I can pin myself for you.',
    note: 'Browser will ask for permission — hit allow and I\'ll update this instantly.',
  },
  listening: {
    label: 'What I\'m listening to',
    value: metadata.favoriteSong || 'Love playlist queued up for you (placeholder track)',
    note: 'Swap this with the real song link when ready. 💿',
  },
};
...
export const contactLinks = [
  ...
  },
  {
    ...
    description: 'Placeholder number — update with the real one when ready.',
  },
  {
    label: 'Send an email',
