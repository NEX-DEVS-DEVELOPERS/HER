...
This document contains realistic demo data for the entertainment content management system. All data is designed to showcase the relationships and functionality of the system.
...
### 2. Users Data (Admin Authentication)

```sql
-- Insert admin users (passwords are bcrypt hashes - these are examples)
INSERT INTO users (username, email, password_hash, role, is_active) VALUES
('admin', 'admin@entertainment.com', '$2b$10$rOzJqQjQjQjQjQjQjQjQjOzJqQjQjQjQjQjQjQjQjQjQjQjQjQjQjQ', 'super_admin', true),
('editor', 'editor@entertainment.com', '$2b$10$rOzJqQjQjQjQjQjQjQjQjOzJqQjQjQjQjQjQjQjQjQjQjQjQjQjQjQ', 'admin', true);
```
...
### 6. TV Series Genres Relationships
...
### Content Statistics
- **Movies**: 10 diverse films spanning different genres and decades (1970s-2010s)
- **TV Series**: 5 popular series with varying seasons and episodes
- **Songs**: 15 classic songs from multiple artists and genres
- **Calendar Events**: 8 events scheduled over the next 6 months
- **Users**: 2 admin users with different permission levels
- **Genres**: 27 total genres covering movies, TV series, songs, and events

### Relationships Demonstrated
- Many-to-many relationships between content and genres
- One-to-many relationships between TV series and seasons/episodes
- User role hierarchy for admin panel access
- Event scheduling with different types and statuses

### Data Quality Features
- Realistic titles, descriptions, and metadata
- Proper date ranges and durations
- Appropriate ratings and status values
- Meaningful relationships between tables
- Diverse content across multiple genres and time periods

This sample data provides a comprehensive foundation for testing the entertainment content management system and demonstrates all the key features and relationships of the database schema.